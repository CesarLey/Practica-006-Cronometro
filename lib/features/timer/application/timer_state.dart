...
/// The `TimerPause` class represents the state of a timer that is currently paused.
class TimerPause extends TimerState {
  const TimerPause(super.duration, super.initialDuration, super.laps);

  @override
  String toString() =>
      'TimerPause { duration: $duration, initialDuration: $initialDuration, laps: ${laps.length} }';
}
