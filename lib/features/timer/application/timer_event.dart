...
/// The `TimerOnPaused` class is a Dart class that represents an event where a timer is paused.
class TimerOnPaused extends TimerEvent {
  const TimerOnPaused();
}

/// The `TimerResumed` class is a Dart class that represents an event where a timer is resumed.
...
/// The `TimerLapPressed` class is a subclass of `TimerEvent` in Dart that represents an event to record a lap.
